...
function Home() {
   return (
      <div className='mt-5 flex items-center justify-around gap-60 lg:gap-x-[60rem]'>
         <img
            className='w-[100px] rounded-[100px] bg-white p-1 m-1 animate-pulse shadow-[0_0_10px] delay-300 duration-300' src={IMG} alt="" />
